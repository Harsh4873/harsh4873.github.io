...
The active production automation runs in GitHub Actions and writes committed JSON for the static GitHub Pages viewer.
...
| `scrapers/scores24_publish_local.sh` | Publishes Scores24WNBA and Scores24MLB from a local Mac because Scores24 blocks GitHub-hosted runner IPs. |
