...
- Do not add or modify Slate or Portfolio source, data, content, or styling from this branch — with one exception: `firestore.rules` intentionally carries the complete Daymark + Slate ruleset and must stay in lockstep with the `slate` branch copy.
